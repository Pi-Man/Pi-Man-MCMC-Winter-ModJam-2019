package piman.wintermodjam2019.client.gui;
...
public class GuiScreenJournal extends GuiScreen
{
    ...
    private GuiScreenJournal.NextPageButton buttonNextPage;
    private GuiScreenJournal.NextPageButton buttonPreviousPage;
    ...
    public GuiScreenJournal(EntityPlayer player, ItemStack book, boolean isUnsigned)
    {
    ...
    public void initGui()
    {
        ...
        int j = 2;
        this.buttonNextPage = (GuiScreenJournal.NextPageButton)this.addButton(new GuiScreenJournal.NextPageButton(1, i + 120, 156, true));
        this.buttonPreviousPage = (GuiScreenJournal.NextPageButton)this.addButton(new GuiScreenJournal.NextPageButton(2, i + 38, 156, false));
        this.updateButtons();
    }
    ...
    static class NextPageButton extends GuiButton
        {
            ...
            public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks)
            {
                if (this.visible)
                {
                    ...
                    GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
                    mc.getTextureManager().bindTexture(GuiScreenJournal.BOOK_GUI_TEXTURES);
                    int i = 0;
                    int j = 192;
