...
public class ChunkGeneratorWinter implements IChunkGenerator
{
    ...
    private MapGenWinterVillage winterVillageGenerator = new MapGenWinterVillage();
    private MapGenWinterVillage largeWinterVillageGenerator = new MapGenWinterVillage();
    ...
    private MapGenStructureContainer otherGenerators = new MapGenStructureContainer();
    ...
    public ChunkGeneratorWinter(World worldIn, long seed, boolean mapFeaturesEnabledIn, String generatorOptions)
    {
        {
            ...
            map.put("size", "20");
            largeWinterVillageGenerator = new MapGenWinterVillage(map);
        }
        this.world = worldIn;
        ...
        {
        	ChunkGeneratorSettings.Factory settingsFactory = ChunkGeneratorSettings.Factory.jsonToFactory(generatorOptions);
        	settingsFactory.useVillages = false;
            this.settings = settingsFactory.build();
    ...
    public Chunk generateChunk(int x, int z)
    {
        ...
        if (x == 0 && z == 0)
        {
        	this.largeWinterVillageGenerator.generate(this.world, x, z, chunkprimer);
        }
        
        this.otherGenerators.generate(world, x, z, chunkprimer);
    ...
    public void populate(int x, int z)
    {
        ...
        flag |= this.largeWinterVillageGenerator.generateStructure(this.world, this.rand, chunkpos);
        
        flag |= this.otherGenerators.generateStructure(world, rand, chunkpos);
...
//        }
        ...
        else if ("WinterVillage".equals(structureName) && this.largeWinterVillageGenerator != null) 
        {
        	return this.largeWinterVillageGenerator.isInsideStructure(pos);
        }
        else if (otherGenerators.hasStructure(structureName))
        {
        	return this.otherGenerators.isInsideStructure(structureName, pos);
        }
        else
        {
...
//        }
        ...
        {
        	return this.largeWinterVillageGenerator.getNearestStructurePos(worldIn, position, findUnexplored);
        }
        else if (otherGenerators.hasStructure(structureName)) 
        {
        	return this.otherGenerators.getNearestStructurePos(structureName, worldIn, position, findUnexplored);
        }
        else
        {
    ...
    public void recreateStructures(Chunk chunkIn, int x, int z)
    {
    	...
    	this.largeWinterVillageGenerator.generate(this.world, x, z, (ChunkPrimer)null);
    	
    	this.otherGenerators.generate(world, x, z, (ChunkPrimer)null);
