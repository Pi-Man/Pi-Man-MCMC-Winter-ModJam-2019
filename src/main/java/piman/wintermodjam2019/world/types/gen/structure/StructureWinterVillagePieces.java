...
public class StructureWinterVillagePieces
{
    public static void registerVillagePieces()
    {
        MapGenStructureIO.registerStructureComponent(StructureWinterVillagePieces.House1.class, "WViBH");
        MapGenStructureIO.registerStructureComponent(StructureWinterVillagePieces.Field1.class, "WViDF");
        MapGenStructureIO.registerStructureComponent(StructureWinterVillagePieces.Field2.class, "WViF");
        MapGenStructureIO.registerStructureComponent(StructureWinterVillagePieces.Torch.class, "WViL");
        MapGenStructureIO.registerStructureComponent(StructureWinterVillagePieces.Hall.class, "WViPH");
        MapGenStructureIO.registerStructureComponent(StructureWinterVillagePieces.House4Garden.class, "WViSH");
        MapGenStructureIO.registerStructureComponent(StructureWinterVillagePieces.WoodHut.class, "WViSmH");
        MapGenStructureIO.registerStructureComponent(StructureWinterVillagePieces.Church.class, "WViST");
        MapGenStructureIO.registerStructureComponent(StructureWinterVillagePieces.House2.class, "WViS");
        MapGenStructureIO.registerStructureComponent(StructureWinterVillagePieces.Start.class, "WViStart");
        MapGenStructureIO.registerStructureComponent(StructureWinterVillagePieces.Path.class, "WViSR");
        MapGenStructureIO.registerStructureComponent(StructureWinterVillagePieces.House3.class, "WViTRH");
        MapGenStructureIO.registerStructureComponent(StructureWinterVillagePieces.Well.class, "WViW");
    }

    public static List<StructureWinterVillagePieces.PieceWeight> getStructureVillageWeightedPieceList(Random random, int size)
    {
        List<StructureWinterVillagePieces.PieceWeight> list = Lists.<StructureWinterVillagePieces.PieceWeight>newArrayList();
        list.add(new StructureWinterVillagePieces.PieceWeight(StructureWinterVillagePieces.House4Garden.class, 4, MathHelper.getInt(random, 2 + size, 4 + size * 2)));
        list.add(new StructureWinterVillagePieces.PieceWeight(StructureWinterVillagePieces.Church.class, 20, MathHelper.getInt(random, 0 + size, 1 + size)));
        list.add(new StructureWinterVillagePieces.PieceWeight(StructureWinterVillagePieces.House1.class, 20, MathHelper.getInt(random, 0 + size, 2 + size)));
        list.add(new StructureWinterVillagePieces.PieceWeight(StructureWinterVillagePieces.WoodHut.class, 3, MathHelper.getInt(random, 2 + size, 5 + size * 3)));
        list.add(new StructureWinterVillagePieces.PieceWeight(StructureWinterVillagePieces.Hall.class, 15, MathHelper.getInt(random, 0 + size, 2 + size)));
        list.add(new StructureWinterVillagePieces.PieceWeight(StructureWinterVillagePieces.Field1.class, 3, MathHelper.getInt(random, 1 + size, 4 + size)));
        list.add(new StructureWinterVillagePieces.PieceWeight(StructureWinterVillagePieces.Field2.class, 3, MathHelper.getInt(random, 2 + size, 4 + size * 2)));
        list.add(new StructureWinterVillagePieces.PieceWeight(StructureWinterVillagePieces.House2.class, 15, MathHelper.getInt(random, 0, 1 + size)));
        list.add(new StructureWinterVillagePieces.PieceWeight(StructureWinterVillagePieces.House3.class, 8, MathHelper.getInt(random, 0 + size, 3 + size * 2)));
        //net.minecraftforge.fml.common.registry.VillagerRegistry.addExtraVillageComponents(list, random, size);
        Iterator<StructureWinterVillagePieces.PieceWeight> iterator = list.iterator();
    ...
    private static int updatePieceWeight(List<StructureWinterVillagePieces.PieceWeight> p_75079_0_)
    {
        boolean flag = false;
        int i = 0;

        for (StructureWinterVillagePieces.PieceWeight structurevillagepieces$pieceweight : p_75079_0_)
        {
    ...
    private static StructureWinterVillagePieces.Village findAndCreateComponentFactory(StructureWinterVillagePieces.Start start, StructureWinterVillagePieces.PieceWeight weight, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        Class <? extends StructureWinterVillagePieces.Village > oclass = weight.villagePieceClass;
        StructureWinterVillagePieces.Village structurevillagepieces$village = null;

        if (oclass == StructureWinterVillagePieces.House4Garden.class)
        {
            structurevillagepieces$village = StructureWinterVillagePieces.House4Garden.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureWinterVillagePieces.Church.class)
        {
            structurevillagepieces$village = StructureWinterVillagePieces.Church.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureWinterVillagePieces.House1.class)
        {
            structurevillagepieces$village = StructureWinterVillagePieces.House1.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureWinterVillagePieces.WoodHut.class)
        {
            structurevillagepieces$village = StructureWinterVillagePieces.WoodHut.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureWinterVillagePieces.Hall.class)
        {
            structurevillagepieces$village = StructureWinterVillagePieces.Hall.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureWinterVillagePieces.Field1.class)
        {
            structurevillagepieces$village = StructureWinterVillagePieces.Field1.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureWinterVillagePieces.Field2.class)
        {
            structurevillagepieces$village = StructureWinterVillagePieces.Field2.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureWinterVillagePieces.House2.class)
        {
            structurevillagepieces$village = StructureWinterVillagePieces.House2.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureWinterVillagePieces.House3.class)
        {
            structurevillagepieces$village = StructureWinterVillagePieces.House3.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else
        {
    ...
    private static StructureWinterVillagePieces.Village generateComponent(StructureWinterVillagePieces.Start start, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        ...
        else
        {
            ...
            while (j < 5)
            {
                ...
                for (StructureWinterVillagePieces.PieceWeight structurevillagepieces$pieceweight : start.structureVillageWeightedPieceList)
                {
                    ...
                    if (k < 0)
                    {
                        ...
                        StructureWinterVillagePieces.Village structurevillagepieces$village = findAndCreateComponentFactory(start, structurevillagepieces$pieceweight, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
            ...
            StructureBoundingBox structureboundingbox = StructureWinterVillagePieces.Torch.findPieceBox(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing);

            if (structureboundingbox != null)
            {
                return new StructureWinterVillagePieces.Torch(start, componentType, rand, structureboundingbox, facing);
            }
            else
            {
                return null;
    ...
    private static StructureComponent generateAndAddComponent(StructureWinterVillagePieces.Start start, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        if (componentType > 50)
        {
            return null;
    ...
    private static StructureComponent generateAndAddRoadPiece(StructureWinterVillagePieces.Start start, List<StructureComponent> p_176069_1_, Random rand, int p_176069_3_, int p_176069_4_, int p_176069_5_, EnumFacing facing, int p_176069_7_)
    {
        ...
        {
            StructureBoundingBox structureboundingbox = StructureWinterVillagePieces.Path.findPieceBox(start, p_176069_1_, rand, p_176069_3_, p_176069_4_, p_176069_5_, facing);

            if (structureboundingbox != null && structureboundingbox.minY > 10)
            {
                StructureComponent structurecomponent = new StructureWinterVillagePieces.Path(start, p_176069_7_, rand, structureboundingbox, facing);
    ...
    public static class Church extends StructureWinterVillagePieces.Village
        {
            public Church()
            {
            }

            public Church(StructureWinterVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45564_4_, EnumFacing facing)
            {
                super(start, type);
            ...
            public static StructureWinterVillagePieces.Church createPiece(StructureWinterVillagePieces.Start start, List<StructureComponent> p_175854_1_, Random rand, int p_175854_3_, int p_175854_4_, int p_175854_5_, EnumFacing facing, int p_175854_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175854_1_, structureboundingbox) == null ? new StructureWinterVillagePieces.Church(start, p_175854_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class Field1 extends StructureWinterVillagePieces.Village
        {
            ...
            public Field1(StructureWinterVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45570_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static StructureWinterVillagePieces.Field1 createPiece(StructureWinterVillagePieces.Start start, List<StructureComponent> p_175851_1_, Random rand, int p_175851_3_, int p_175851_4_, int p_175851_5_, EnumFacing facing, int p_175851_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175851_1_, structureboundingbox) == null ? new StructureWinterVillagePieces.Field1(start, p_175851_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class Field2 extends StructureWinterVillagePieces.Village
        {
            /** First crop type for this field. */
            private Block cropTypeA;
            /** Second crop type for this field. */
            ...
            public Field2(StructureWinterVillagePieces.Start start, int p_i45569_2_, Random rand, StructureBoundingBox p_i45569_4_, EnumFacing facing)
            {
            ...
            public static StructureWinterVillagePieces.Field2 createPiece(StructureWinterVillagePieces.Start start, List<StructureComponent> p_175852_1_, Random rand, int p_175852_3_, int p_175852_4_, int p_175852_5_, EnumFacing facing, int p_175852_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175852_1_, structureboundingbox) == null ? new StructureWinterVillagePieces.Field2(start, p_175852_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class Hall extends StructureWinterVillagePieces.Village
        {
            public Hall()
            {
            }

            public Hall(StructureWinterVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45567_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static StructureWinterVillagePieces.Hall createPiece(StructureWinterVillagePieces.Start start, List<StructureComponent> p_175857_1_, Random rand, int p_175857_3_, int p_175857_4_, int p_175857_5_, EnumFacing facing, int p_175857_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175857_1_, structureboundingbox) == null ? new StructureWinterVillagePieces.Hall(start, p_175857_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class House1 extends StructureWinterVillagePieces.Village
        {
            public House1()
            {
            }

            public House1(StructureWinterVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45571_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static StructureWinterVillagePieces.House1 createPiece(StructureWinterVillagePieces.Start start, List<StructureComponent> p_175850_1_, Random rand, int p_175850_3_, int p_175850_4_, int p_175850_5_, EnumFacing facing, int p_175850_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175850_1_, structureboundingbox) == null ? new StructureWinterVillagePieces.House1(start, p_175850_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class House2 extends StructureWinterVillagePieces.Village
        {
            ...
            public House2(StructureWinterVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45563_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static StructureWinterVillagePieces.House2 createPiece(StructureWinterVillagePieces.Start start, List<StructureComponent> p_175855_1_, Random rand, int p_175855_3_, int p_175855_4_, int p_175855_5_, EnumFacing facing, int p_175855_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175855_1_, structureboundingbox) == null ? new StructureWinterVillagePieces.House2(start, p_175855_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class House3 extends StructureWinterVillagePieces.Village
        {
            public House3()
            {
            }

            public House3(StructureWinterVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45561_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static StructureWinterVillagePieces.House3 createPiece(StructureWinterVillagePieces.Start start, List<StructureComponent> p_175849_1_, Random rand, int p_175849_3_, int p_175849_4_, int p_175849_5_, EnumFacing facing, int p_175849_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175849_1_, structureboundingbox) == null ? new StructureWinterVillagePieces.House3(start, p_175849_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class House4Garden extends StructureWinterVillagePieces.Village
        {
            ...
            public House4Garden(StructureWinterVillagePieces.Start start, int p_i45566_2_, Random rand, StructureBoundingBox p_i45566_4_, EnumFacing facing)
            {
            ...
            public static StructureWinterVillagePieces.House4Garden createPiece(StructureWinterVillagePieces.Start start, List<StructureComponent> p_175858_1_, Random rand, int p_175858_3_, int p_175858_4_, int p_175858_5_, EnumFacing facing, int p_175858_7_)
            {
                ...
                return StructureComponent.findIntersecting(p_175858_1_, structureboundingbox) != null ? null : new StructureWinterVillagePieces.House4Garden(start, p_175858_7_, rand, structureboundingbox, facing);
            }
    ...
    public static class Path extends StructureWinterVillagePieces.Road
        {
            private int length;
            ...
            public Path(StructureWinterVillagePieces.Start start, int p_i45562_2_, Random rand, StructureBoundingBox p_i45562_4_, EnumFacing facing)
            {
            ...
            public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
            {
                ...
                {
                    StructureComponent structurecomponent = this.getNextComponentNN((StructureWinterVillagePieces.Start)componentIn, listIn, rand, 0, i);
                ...
                {
                    StructureComponent structurecomponent1 = this.getNextComponentPP((StructureWinterVillagePieces.Start)componentIn, listIn, rand, 0, j);
                ...
                if (flag && enumfacing != null)
                {
                    switch (enumfacing)
                    {
                        case NORTH:
                        default:
                            StructureWinterVillagePieces.generateAndAddRoadPiece((StructureWinterVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.WEST, this.getComponentType());
                            break;
                        case SOUTH:
                            StructureWinterVillagePieces.generateAndAddRoadPiece((StructureWinterVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.WEST, this.getComponentType());
                            break;
                        case WEST:
                            StructureWinterVillagePieces.generateAndAddRoadPiece((StructureWinterVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                            break;
                        case EAST:
                            StructureWinterVillagePieces.generateAndAddRoadPiece((StructureWinterVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                    }
                }
                ...
                if (flag && enumfacing != null)
                {
                    switch (enumfacing)
                    {
                        case NORTH:
                        default:
                            StructureWinterVillagePieces.generateAndAddRoadPiece((StructureWinterVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.EAST, this.getComponentType());
                            break;
                        case SOUTH:
                            StructureWinterVillagePieces.generateAndAddRoadPiece((StructureWinterVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.EAST, this.getComponentType());
                            break;
                        case WEST:
                            StructureWinterVillagePieces.generateAndAddRoadPiece((StructureWinterVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                            break;
                        case EAST:
                            StructureWinterVillagePieces.generateAndAddRoadPiece((StructureWinterVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                    }
                }
            }

            public static StructureBoundingBox findPieceBox(StructureWinterVillagePieces.Start start, List<StructureComponent> p_175848_1_, Random rand, int p_175848_3_, int p_175848_4_, int p_175848_5_, EnumFacing facing)
            {
    ...
    public static class PieceWeight
        {
            public Class <? extends StructureWinterVillagePieces.Village > villagePieceClass;
            public final int villagePieceWeight;
            public int villagePiecesSpawned;
            public int villagePiecesLimit;

            public PieceWeight(Class <? extends StructureWinterVillagePieces.Village > p_i2098_1_, int p_i2098_2_, int p_i2098_3_)
            {
    ...
    public abstract static class Road extends StructureWinterVillagePieces.Village
        {
            public Road()
            {
            }

            protected Road(StructureWinterVillagePieces.Start start, int type)
            {
                super(start, type);
            }
        }

    public static class Start extends StructureWinterVillagePieces.Well
        {
            public BiomeProvider biomeProvider;
            /** World terrain type, 0 for normal, 1 for flap map */
            public int terrainType;
            public StructureWinterVillagePieces.PieceWeight lastPlaced;
            /**
             ...
             */
            public List<StructureWinterVillagePieces.PieceWeight> structureVillageWeightedPieceList;
            ...
            public Start(BiomeProvider biomeProviderIn, int p_i2104_2_, Random rand, int p_i2104_4_, int p_i2104_5_, List<StructureWinterVillagePieces.PieceWeight> p_i2104_6_, int p_i2104_7_)
            {
                super((StructureWinterVillagePieces.Start)null, 0, rand, p_i2104_4_, p_i2104_5_);
    ...
    public static class Torch extends StructureWinterVillagePieces.Village
        {
            public Torch()
            {
            }

            public Torch(StructureWinterVillagePieces.Start start, int p_i45568_2_, Random rand, StructureBoundingBox p_i45568_4_, EnumFacing facing)
            {
            ...
            public static StructureBoundingBox findPieceBox(StructureWinterVillagePieces.Start start, List<StructureComponent> p_175856_1_, Random rand, int p_175856_3_, int p_175856_4_, int p_175856_5_, EnumFacing facing)
            {
    ...
    public abstract static class Village extends StructureComponent
        {
            ...
            protected StructureWinterVillagePieces.Start startPiece;

            public Village()
            {
            }

            protected Village(StructureWinterVillagePieces.Start start, int type)
            {
                super(type);
             ...
             */
            @Nullable
            protected StructureComponent getNextComponentNN(StructureWinterVillagePieces.Start start, List<StructureComponent> structureComponents, Random rand, int p_74891_4_, int p_74891_5_)
            {
                EnumFacing enumfacing = this.getCoordBaseMode();
                ...
                if (enumfacing != null)
                {
                    switch (enumfacing)
                    {
                        case NORTH:
                        default:
                            return StructureWinterVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, EnumFacing.WEST, this.getComponentType());
                        case SOUTH:
                            return StructureWinterVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, EnumFacing.WEST, this.getComponentType());
                        case WEST:
                            return StructureWinterVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                        case EAST:
                            return StructureWinterVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                    }
                }
             ...
             */
            @Nullable
            protected StructureComponent getNextComponentPP(StructureWinterVillagePieces.Start start, List<StructureComponent> structureComponents, Random rand, int p_74894_4_, int p_74894_5_)
            {
                EnumFacing enumfacing = this.getCoordBaseMode();
                ...
                if (enumfacing != null)
                {
                    switch (enumfacing)
                    {
                        case NORTH:
                        default:
                            return StructureWinterVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, EnumFacing.EAST, this.getComponentType());
                        case SOUTH:
                            return StructureWinterVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, EnumFacing.EAST, this.getComponentType());
                        case WEST:
                            return StructureWinterVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                        case EAST:
                            return StructureWinterVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                    }
                }
    ...
    public static class Well extends StructureWinterVillagePieces.Village
        {
            public Well()
            {
            }

            public Well(StructureWinterVillagePieces.Start start, int type, Random rand, int x, int z)
            {
                super(start, type);
            ...
            public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
            {
                StructureWinterVillagePieces.generateAndAddRoadPiece((StructureWinterVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.WEST, this.getComponentType());
                StructureWinterVillagePieces.generateAndAddRoadPiece((StructureWinterVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.EAST, this.getComponentType());
                StructureWinterVillagePieces.generateAndAddRoadPiece((StructureWinterVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                StructureWinterVillagePieces.generateAndAddRoadPiece((StructureWinterVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
            }
    ...
    public static class WoodHut extends StructureWinterVillagePieces.Village
        {
            ...
            public WoodHut(StructureWinterVillagePieces.Start start, int type, Random rand, StructureBoundingBox structurebb, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static StructureWinterVillagePieces.WoodHut createPiece(StructureWinterVillagePieces.Start start, List<StructureComponent> p_175853_1_, Random rand, int p_175853_3_, int p_175853_4_, int p_175853_5_, EnumFacing facing, int p_175853_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175853_1_, structureboundingbox) == null ? new StructureWinterVillagePieces.WoodHut(start, p_175853_7_, rand, structureboundingbox, facing) : null;
            }
