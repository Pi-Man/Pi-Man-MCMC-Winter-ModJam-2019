...
public class MapGenWinterVillage extends MapGenStructure
{
    ...
    public MapGenWinterVillage()
    {
        this.distance = 32;
        this.minTownSeparation = 8;
    }

    public MapGenWinterVillage(Map<String, String> map)
    {
        this();
    ...
    {
        return Main.MODID + ":WinterVillage";
    }
    ...
    {
        return new MapGenWinterVillage.Start(this.world, this.rand, chunkX, chunkZ, this.size);
    }
    ...
    public static class Start extends StructureStart
        {
            ...
            {
                super(x, z);
                List<StructureWinterVillagePieces.PieceWeight> list = StructureWinterVillagePieces.getStructureVillageWeightedPieceList(rand, size);
                StructureWinterVillagePieces.Start structurevillagepieces$start = new StructureWinterVillagePieces.Start(worldIn.getBiomeProvider(), 0, rand, (x << 4) + 2, (z << 4) + 2, list, size);
