...
public class StructureAbandonedVillagePieces
{
	...
	public static final BlockSelector COBBLEMOSS5050 = new BlockSelector() {
		@Override
		public void selectBlocks(Random rand, int x, int y, int z, boolean wall) {
			IBlockState[] states = new IBlockState[] {Blocks.COBBLESTONE.getDefaultState(), Blocks.MOSSY_COBBLESTONE.getDefaultState()};
    ...
    public static void registerVillagePieces()
    {
        ...
        MapGenStructureIO.registerStructureComponent(StructureAbandonedVillagePieces.WoodHut.class, "AViSmH");
        MapGenStructureIO.registerStructureComponent(StructureAbandonedVillagePieces.Church.class, "AViST");
        MapGenStructureIO.registerStructureComponent(StructureAbandonedVillagePieces.House2.class, "AViS");
        MapGenStructureIO.registerStructureComponent(StructureAbandonedVillagePieces.Start.class, "AViStart");
        MapGenStructureIO.registerStructureComponent(StructureAbandonedVillagePieces.Path.class, "AViSR");
        MapGenStructureIO.registerStructureComponent(StructureAbandonedVillagePieces.House3.class, "AViTRH");
        MapGenStructureIO.registerStructureComponent(StructureAbandonedVillagePieces.Well.class, "AViW");
    }

    public static List<StructureAbandonedVillagePieces.PieceWeight> getStructureVillageWeightedPieceList(Random random, int size)
    {
        List<StructureAbandonedVillagePieces.PieceWeight> list = Lists.<StructureAbandonedVillagePieces.PieceWeight>newArrayList();
        list.add(new StructureAbandonedVillagePieces.PieceWeight(StructureAbandonedVillagePieces.House4Garden.class, 4, MathHelper.getInt(random, 2 + size, 4 + size * 2)));
        list.add(new StructureAbandonedVillagePieces.PieceWeight(StructureAbandonedVillagePieces.Church.class, 20, MathHelper.getInt(random, 0 + size, 1 + size)));
        list.add(new StructureAbandonedVillagePieces.PieceWeight(StructureAbandonedVillagePieces.House1.class, 20, MathHelper.getInt(random, 0 + size, 2 + size)));
        list.add(new StructureAbandonedVillagePieces.PieceWeight(StructureAbandonedVillagePieces.WoodHut.class, 3, MathHelper.getInt(random, 2 + size, 5 + size * 3)));
        list.add(new StructureAbandonedVillagePieces.PieceWeight(StructureAbandonedVillagePieces.Hall.class, 15, MathHelper.getInt(random, 0 + size, 2 + size)));
//        list.add(new StructureAbandonedVillagePieces.PieceWeight(StructureAbandonedVillagePieces.Field1.class, 3, MathHelper.getInt(random, 1 + size, 4 + size)));
//        list.add(new StructureAbandonedVillagePieces.PieceWeight(StructureAbandonedVillagePieces.Field2.class, 3, MathHelper.getInt(random, 2 + size, 4 + size * 2)));
        list.add(new StructureAbandonedVillagePieces.PieceWeight(StructureAbandonedVillagePieces.House2.class, 15, MathHelper.getInt(random, 0, 1 + size)));
        list.add(new StructureAbandonedVillagePieces.PieceWeight(StructureAbandonedVillagePieces.House3.class, 8, MathHelper.getInt(random, 0 + size, 3 + size * 2)));
        //net.minecraftforge.fml.common.registry.VillagerRegistry.addExtraVillageComponents(list, random, size);
        Iterator<StructureAbandonedVillagePieces.PieceWeight> iterator = list.iterator();
    ...
    private static int updatePieceWeight(List<StructureAbandonedVillagePieces.PieceWeight> p_75079_0_)
    {
        boolean flag = false;
        int i = 0;

        for (StructureAbandonedVillagePieces.PieceWeight structurevillagepieces$pieceweight : p_75079_0_)
        {
    ...
    private static StructureAbandonedVillagePieces.Village findAndCreateComponentFactory(StructureAbandonedVillagePieces.Start start, StructureAbandonedVillagePieces.PieceWeight weight, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        Class <? extends StructureAbandonedVillagePieces.Village > oclass = weight.villagePieceClass;
        StructureAbandonedVillagePieces.Village structurevillagepieces$village = null;

        if (oclass == StructureAbandonedVillagePieces.House4Garden.class)
        {
            structurevillagepieces$village = StructureAbandonedVillagePieces.House4Garden.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureAbandonedVillagePieces.Church.class)
        {
            structurevillagepieces$village = StructureAbandonedVillagePieces.Church.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureAbandonedVillagePieces.House1.class)
        {
            structurevillagepieces$village = StructureAbandonedVillagePieces.House1.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureAbandonedVillagePieces.WoodHut.class)
        {
            structurevillagepieces$village = StructureAbandonedVillagePieces.WoodHut.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureAbandonedVillagePieces.Hall.class)
        {
            structurevillagepieces$village = StructureAbandonedVillagePieces.Hall.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureAbandonedVillagePieces.Field1.class)
        {
            structurevillagepieces$village = StructureAbandonedVillagePieces.Field1.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureAbandonedVillagePieces.Field2.class)
        {
            structurevillagepieces$village = StructureAbandonedVillagePieces.Field2.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureAbandonedVillagePieces.House2.class)
        {
            structurevillagepieces$village = StructureAbandonedVillagePieces.House2.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else if (oclass == StructureAbandonedVillagePieces.House3.class)
        {
            structurevillagepieces$village = StructureAbandonedVillagePieces.House3.createPiece(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
        }
        else
        {
    ...
    private static StructureAbandonedVillagePieces.Village generateComponent(StructureAbandonedVillagePieces.Start start, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        ...
        else
        {
            ...
            while (j < 5)
            {
                ...
                for (StructureAbandonedVillagePieces.PieceWeight structurevillagepieces$pieceweight : start.structureVillageWeightedPieceList)
                {
                    ...
                    if (k < 0)
                    {
                        ...
                        StructureAbandonedVillagePieces.Village structurevillagepieces$village = findAndCreateComponentFactory(start, structurevillagepieces$pieceweight, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing, componentType);
            ...
            StructureBoundingBox structureboundingbox = StructureAbandonedVillagePieces.Torch.findPieceBox(start, structureComponents, rand, structureMinX, structureMinY, structureMinZ, facing);

            if (structureboundingbox != null)
            {
                return new StructureAbandonedVillagePieces.Torch(start, componentType, rand, structureboundingbox, facing);
            }
            else
            {
                return null;
    ...
    private static StructureComponent generateAndAddComponent(StructureAbandonedVillagePieces.Start start, List<StructureComponent> structureComponents, Random rand, int structureMinX, int structureMinY, int structureMinZ, EnumFacing facing, int componentType)
    {
        if (componentType > 50)
        {
            return null;
        }
        else if (Math.abs(start.averageXB(structureMinX) - start.getBoundingBox().minX) <= 500 && Math.abs(start.averageZB(structureMinZ) - start.getBoundingBox().minZ) <= 500)
        {
            ...
            if (structurecomponent != null)
            {
                ...
                start.addPosB(structureMinX, structureMinZ);
    ...
    private static StructureComponent generateAndAddRoadPiece(StructureAbandonedVillagePieces.Start start, List<StructureComponent> p_176069_1_, Random rand, int p_176069_3_, int p_176069_4_, int p_176069_5_, EnumFacing facing, int p_176069_7_)
    {
        if (p_176069_7_ > 3 + start.terrainType)
        {
            return null;
        }
        else if (Math.abs(p_176069_3_ - start.getBoundingBox().minX) <= 500 && Math.abs(p_176069_5_ - start.getBoundingBox().minZ) <= 500)// && Math.abs(start.averageXP(p_176069_3_) - start.getBoundingBox().minX) <= 20 && Math.abs(start.averageZP(p_176069_5_) - start.getBoundingBox().minZ) <= 20)
        {
            StructureBoundingBox structureboundingbox = StructureAbandonedVillagePieces.Path.findPieceBox(start, p_176069_1_, rand, p_176069_3_, p_176069_4_, p_176069_5_, facing);

            if (structureboundingbox != null && structureboundingbox.minY > 10)
            {
                StructureComponent structurecomponent = new StructureAbandonedVillagePieces.Path(start, p_176069_7_, rand, structureboundingbox, facing);
                p_176069_1_.add(structurecomponent);
                start.pendingRoads.add(structurecomponent);
                start.addPosP(p_176069_3_, p_176069_5_);
                return structurecomponent;
            }
            else
            {
    ...
    public static class Church extends StructureAbandonedVillagePieces.Village
        {
            ...
            public Church(StructureAbandonedVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45564_4_, EnumFacing facing)
            {
                super(start, type);
            ...
            public static StructureAbandonedVillagePieces.Church createPiece(StructureAbandonedVillagePieces.Start start, List<StructureComponent> p_175854_1_, Random rand, int p_175854_3_, int p_175854_4_, int p_175854_5_, EnumFacing facing, int p_175854_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175854_1_, structureboundingbox) == null ? new StructureAbandonedVillagePieces.Church(start, p_175854_7_, rand, structureboundingbox, facing) : null;
            }
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 1, 0, 0, 3, 0, 8, false, randomIn, COBBLEMOSS5050);
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 1, 1, 0, 3, 10, 0, false, randomIn, COBBLEMOSS5050);
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 0, 1, 1, 0, 10, 3, false, randomIn, COBBLEMOSS5050);
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 4, 1, 1, 4, 10, 3, false, randomIn, COBBLEMOSS5050);
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 0, 0, 4, 0, 4, 7, false, randomIn, COBBLEMOSS5050);
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 4, 0, 4, 4, 4, 7, false, randomIn, COBBLEMOSS5050);
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 1, 1, 8, 3, 4, 8, false, randomIn, COBBLEMOSS5050);
                //this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 1, 5, 4, 3, 10, 4, false, randomIn, COBBLEMOSS5050);
...
//                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 0, 4, 0, 4, 4, 4, iblockstate, iblockstate, false);
                this.setBlockState(randomIn, worldIn, COBBLEMOSS5050, 0, 11, 2, structureBoundingBoxIn);
                this.setBlockState(randomIn, worldIn, COBBLEMOSS5050, 4, 11, 2, structureBoundingBoxIn);
                this.setBlockState(randomIn, worldIn, COBBLEMOSS5050, 2, 11, 0, structureBoundingBoxIn);
                //this.setBlockState(randomIn, worldIn, COBBLEMOSS5050, 2, 11, 4, structureBoundingBoxIn);
                this.setBlockState(randomIn, worldIn, COBBLEMOSS5050, 1, 1, 6, structureBoundingBoxIn);
                this.setBlockState(randomIn, worldIn, COBBLEMOSS5050, 1, 1, 7, structureBoundingBoxIn);
                this.setBlockState(randomIn, worldIn, COBBLEMOSS5050, 2, 1, 7, structureBoundingBoxIn);
                this.setBlockState(randomIn, worldIn, COBBLEMOSS5050, 3, 1, 6, structureBoundingBoxIn);
                this.setBlockState(randomIn, worldIn, COBBLEMOSS5050, 3, 1, 7, structureBoundingBoxIn);
...
//                }
                ...
                for (int i = 4; i < 8; i++) {
                	this.fillWithAir(worldIn, structureBoundingBoxIn, 0, 5 - randomIn.nextInt(3), i, 0, 5, i);
                }
                for (int i = 4; i < 8; i++) {
                	this.fillWithAir(worldIn, structureBoundingBoxIn, 4, 5 - randomIn.nextInt(3), i, 4, 5, i);
                }
                for (int i = 1; i < 4; i++) {
                	this.fillWithAir(worldIn, structureBoundingBoxIn, i, 5 - randomIn.nextInt(3), 8, i, 5, 8);
                }
                
                for (int i = 1; i < 4; i++) {
                	this.fillWithAir(worldIn, structureBoundingBoxIn, 0, 6 - randomIn.nextInt(3), 1, 0, 12, i);
                }
                for (int i = 1; i < 4; i++) {
                	this.fillWithAir(worldIn, structureBoundingBoxIn, 4, 6 - randomIn.nextInt(3), 1, 4, 12, i);
                }
                for (int i = 1; i < 4; i++) {
                	this.fillWithAir(worldIn, structureBoundingBoxIn, i, 6 - randomIn.nextInt(3), 0, i, 12, 0);
                }
    ...
    public static class Field1 extends StructureAbandonedVillagePieces.Village
        {
            ...
            public Field1(StructureAbandonedVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45570_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static StructureAbandonedVillagePieces.Field1 createPiece(StructureAbandonedVillagePieces.Start start, List<StructureComponent> p_175851_1_, Random rand, int p_175851_3_, int p_175851_4_, int p_175851_5_, EnumFacing facing, int p_175851_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175851_1_, structureboundingbox) == null ? new StructureAbandonedVillagePieces.Field1(start, p_175851_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class Field2 extends StructureAbandonedVillagePieces.Village
        {
            ...
            public Field2(StructureAbandonedVillagePieces.Start start, int p_i45569_2_, Random rand, StructureBoundingBox p_i45569_4_, EnumFacing facing)
            {
            ...
            public static StructureAbandonedVillagePieces.Field2 createPiece(StructureAbandonedVillagePieces.Start start, List<StructureComponent> p_175852_1_, Random rand, int p_175852_3_, int p_175852_4_, int p_175852_5_, EnumFacing facing, int p_175852_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175852_1_, structureboundingbox) == null ? new StructureAbandonedVillagePieces.Field2(start, p_175852_7_, rand, structureboundingbox, facing) : null;
            }
    ...
    public static class Hall extends StructureAbandonedVillagePieces.Village
        {
            ...
            public Hall(StructureAbandonedVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45567_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static StructureAbandonedVillagePieces.Hall createPiece(StructureAbandonedVillagePieces.Start start, List<StructureComponent> p_175857_1_, Random rand, int p_175857_3_, int p_175857_4_, int p_175857_5_, EnumFacing facing, int p_175857_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175857_1_, structureboundingbox) == null ? new StructureAbandonedVillagePieces.Hall(start, p_175857_7_, rand, structureboundingbox, facing) : null;
            }
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
               ...
               // IBlockState iblockstate4 = this.getBiomeSpecificBlockState(Blocks.PLANKS.getDefaultState());
                ...
                this.setBlockState(randomIn, worldIn, COBBLEMOSS5050, 6, 0, 6, structureBoundingBoxIn);
...
//                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 0, 1, 7, 0, 4, iblockstate4, iblockstate4, false);
                ...
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 1, 0, 5, 7, 1, 5, false, randomIn, COBBLEMOSS5050);
...
//                }
                ...
                for (int k = 0; k < 5; ++k)
                {
                    for (int l = 0; l < 9; ++l)
                    {
                        ...
                        this.replaceAirAndLiquidDownwards(randomIn, worldIn, COBBLEMOSS5050, l, -1, k, structureBoundingBoxIn);
                    }
                }
    ...
    public static class House1 extends StructureAbandonedVillagePieces.Village
        {
            public House1()
            {
            }

            public House1(StructureAbandonedVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45571_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static StructureAbandonedVillagePieces.House1 createPiece(StructureAbandonedVillagePieces.Start start, List<StructureComponent> p_175850_1_, Random rand, int p_175850_3_, int p_175850_4_, int p_175850_5_, EnumFacing facing, int p_175850_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175850_1_, structureboundingbox) == null ? new StructureAbandonedVillagePieces.House1(start, p_175850_7_, rand, structureboundingbox, facing) : null;
            }
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 0, 0, 0, 8, 0, 5, false, randomIn, COBBLEMOSS5050);
...
//                }
                ...
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 0, 1, 0, 0, 1, 5, false, randomIn, COBBLEMOSS5050);
                ...
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 8, 2, 0, 8, 2 + randomIn.nextInt(3), 0, false, randomIn, COBBLEMOSS5050);
...
//                this.setBlockState(worldIn, Blocks.CRAFTING_TABLE.getDefaultState(), 7, 1, 1, structureBoundingBoxIn);
               ...
               // this.createVillageDoor(worldIn, structureBoundingBoxIn, randomIn, 1, 1, 0, EnumFacing.NORTH);
                ...
                for (int l = 0; l < 6; ++l)
                {
                    for (int k = 0; k < 9; ++k)
                    {
                        ...
                        this.replaceAirAndLiquidDownwards(randomIn, worldIn, COBBLEMOSS5050, k, -1, l, structureBoundingBoxIn);
                    }
                }
    ...
    public static class House2 extends StructureAbandonedVillagePieces.Village
        {
            ...
            public House2(StructureAbandonedVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45563_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static StructureAbandonedVillagePieces.House2 createPiece(StructureAbandonedVillagePieces.Start start, List<StructureComponent> p_175855_1_, Random rand, int p_175855_3_, int p_175855_4_, int p_175855_5_, EnumFacing facing, int p_175855_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175855_1_, structureboundingbox) == null ? new StructureAbandonedVillagePieces.House2(start, p_175855_7_, rand, structureboundingbox, facing) : null;
            }
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 0, 0, 0, 9, 0, 6, false, randomIn, COBBLEMOSS5050);
...
//                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 9, 1, 0, 9, 3, 0, iblockstate6, iblockstate6, false);
                ...
                this.setBlockState(randomIn, worldIn, COBBLEMOSS5050, 6, 1, 3, structureBoundingBoxIn);
...
//                this.setBlockState(worldIn, iblockstate2, 1, 1, 4, structureBoundingBoxIn);
                ...
                if (!this.hasMadeChest && structureBoundingBoxIn.isVecInside(new BlockPos(this.getXWithOffset(5, 5), this.getYWithOffset(1), this.getZWithOffset(5, 5))))
                {
                    ...
                    this.generateChest(worldIn, structureBoundingBoxIn, randomIn, 5, 1, 5, LootTableList.EMPTY);
                }
...
//                }
                ...
                for (int k = 0; k < 7; ++k)
                {
                    for (int j = 0; j < 10; ++j)
                    {
                        ...
                        this.replaceAirAndLiquidDownwards(randomIn, worldIn, COBBLEMOSS5050, j, -1, k, structureBoundingBoxIn);
                    }
                }
    ...
    public static class House3 extends StructureAbandonedVillagePieces.Village
        {
            ...
            public House3(StructureAbandonedVillagePieces.Start start, int type, Random rand, StructureBoundingBox p_i45561_4_, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static StructureAbandonedVillagePieces.House3 createPiece(StructureAbandonedVillagePieces.Start start, List<StructureComponent> p_175849_1_, Random rand, int p_175849_3_, int p_175849_4_, int p_175849_5_, EnumFacing facing, int p_175849_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175849_1_, structureboundingbox) == null ? new StructureAbandonedVillagePieces.House3(start, p_175849_7_, rand, structureboundingbox, facing) : null;
            }
...
//                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 0, 1, 7, 0, 4, iblockstate5, iblockstate5, false);
                ...
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 1, 0, 5, 2, 1, 5, false, randomIn, COBBLEMOSS5050);
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 2, 0, 6, 2, 3, 10, false, randomIn, COBBLEMOSS5050);
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 3, 0, 10, 7, 3, 10, false, randomIn, COBBLEMOSS5050);
                for (int i = 0; i <= 5; i++) {
                	this.fillWithAir(worldIn, structureBoundingBoxIn, 0, 4 - randomIn.nextInt(3), i, 0, 4, i);
                }
                for (int i = 0; i <= 10; i++) {
                	this.fillWithAir(worldIn, structureBoundingBoxIn, 8, 4 - randomIn.nextInt(3), i, 8, 4, i);
                }
                for (int i = 1; i <= 7; i++) {
                	this.fillWithAir(worldIn, structureBoundingBoxIn, i, 4 - randomIn.nextInt(3), 0, i, 4, 0);
                }
                for (int i = 1; i <= 2; i++) {
                	this.fillWithAir(worldIn, structureBoundingBoxIn, i, 4 - randomIn.nextInt(3), 5, i, 4, 5);
                }
                for (int i = 6; i <= 10; i++) {
                	this.fillWithAir(worldIn, structureBoundingBoxIn, 2, 4 - randomIn.nextInt(3), i, 2, 4, i);
                }
                for (int i = 3; i <= 7; i++) {
                	this.fillWithAir(worldIn, structureBoundingBoxIn, i, 4 - randomIn.nextInt(3), 10, i, 4, 10);
                }
...
//                }
                ...
                for (int i1 = 0; i1 < 5; ++i1)
                {
                    for (int i2 = 0; i2 < 9; ++i2)
                    {
                        ...
                        this.replaceAirAndLiquidDownwards(randomIn, worldIn, COBBLEMOSS5050, i2, -1, i1, structureBoundingBoxIn);
                    }
                }
                ...
                for (int j1 = 5; j1 < 11; ++j1)
                {
                    for (int j2 = 2; j2 < 9; ++j2)
                    {
                        ...
                        this.replaceAirAndLiquidDownwards(randomIn, worldIn, COBBLEMOSS5050, j2, -1, j1, structureBoundingBoxIn);
                    }
                }
    ...
    public static class House4Garden extends StructureAbandonedVillagePieces.Village
        {
            ...
            public House4Garden(StructureAbandonedVillagePieces.Start start, int p_i45566_2_, Random rand, StructureBoundingBox p_i45566_4_, EnumFacing facing)
            {
            ...
            public static StructureAbandonedVillagePieces.House4Garden createPiece(StructureAbandonedVillagePieces.Start start, List<StructureComponent> p_175858_1_, Random rand, int p_175858_3_, int p_175858_4_, int p_175858_5_, EnumFacing facing, int p_175858_7_)
            {
                ...
                return StructureComponent.findIntersecting(p_175858_1_, structureboundingbox) != null ? null : new StructureAbandonedVillagePieces.House4Garden(start, p_175858_7_, rand, structureboundingbox, facing);
            }
...
//                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 4, 1, 3, 4, 3, iblockstate1, iblockstate1, false);
                ...
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 4, 1, 4, 0, 1 + randomIn.nextInt(3), 0, false, randomIn, COBBLEMOSS5050);
...
//                }
                ...
                for (int j = 0; j < 5; ++j)
                {
                    for (int i = 0; i < 5; ++i)
                    {
                        ...
                        this.replaceAirAndLiquidDownwards(randomIn, worldIn, COBBLEMOSS5050, i, -1, j, structureBoundingBoxIn);
                    }
                }
    ...
    public static class Path extends StructureAbandonedVillagePieces.Road
        {
            ...
            public Path(StructureAbandonedVillagePieces.Start start, int p_i45562_2_, Random rand, StructureBoundingBox p_i45562_4_, EnumFacing facing)
            {
            ...
            public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
            {
                ...
                {
                    StructureComponent structurecomponent = this.getNextComponentNN((StructureAbandonedVillagePieces.Start)componentIn, listIn, rand, 0, i);
                ...
                {
                    StructureComponent structurecomponent1 = this.getNextComponentPP((StructureAbandonedVillagePieces.Start)componentIn, listIn, rand, 0, j);
                ...
                if (flag && enumfacing != null)
                {
                    switch (enumfacing)
                    {
                        case NORTH:
                        default:
                            StructureAbandonedVillagePieces.generateAndAddRoadPiece((StructureAbandonedVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.WEST, this.getComponentType());
                            break;
                        case SOUTH:
                            StructureAbandonedVillagePieces.generateAndAddRoadPiece((StructureAbandonedVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.WEST, this.getComponentType());
                            break;
                        case WEST:
                            StructureAbandonedVillagePieces.generateAndAddRoadPiece((StructureAbandonedVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                            break;
                        case EAST:
                            StructureAbandonedVillagePieces.generateAndAddRoadPiece((StructureAbandonedVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                    }
                }
                ...
                if (flag && enumfacing != null)
                {
                    switch (enumfacing)
                    {
                        case NORTH:
                        default:
                            StructureAbandonedVillagePieces.generateAndAddRoadPiece((StructureAbandonedVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.EAST, this.getComponentType());
                            break;
                        case SOUTH:
                            StructureAbandonedVillagePieces.generateAndAddRoadPiece((StructureAbandonedVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.EAST, this.getComponentType());
                            break;
                        case WEST:
                            StructureAbandonedVillagePieces.generateAndAddRoadPiece((StructureAbandonedVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                            break;
                        case EAST:
                            StructureAbandonedVillagePieces.generateAndAddRoadPiece((StructureAbandonedVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                    }
                }
            }

            public static StructureBoundingBox findPieceBox(StructureAbandonedVillagePieces.Start start, List<StructureComponent> p_175848_1_, Random rand, int p_175848_3_, int p_175848_4_, int p_175848_5_, EnumFacing facing)
            {
...
//                IBlockState iblockstate1 = this.getBiomeSpecificBlockState(Blocks.PLANKS.getDefaultState());
    ...
    public static class PieceWeight
        {
            public Class <? extends StructureAbandonedVillagePieces.Village > villagePieceClass;
            public final int villagePieceWeight;
            public int villagePiecesSpawned;
            public int villagePiecesLimit;

            public PieceWeight(Class <? extends StructureAbandonedVillagePieces.Village > p_i2098_1_, int p_i2098_2_, int p_i2098_3_)
            {
    ...
    public abstract static class Road extends StructureAbandonedVillagePieces.Village
        {
            ...
            protected Road(StructureAbandonedVillagePieces.Start start, int type)
            {
                super(start, type);
            }
        }
    ...
    public static class Start extends StructureAbandonedVillagePieces.Well
        {
            ...
            public StructureAbandonedVillagePieces.PieceWeight lastPlaced;
            /**
             ...
             */
            public List<StructureAbandonedVillagePieces.PieceWeight> structureVillageWeightedPieceList;
            ...
            public void addPosB(int x, int z) {
            	this.totalXB += x;
            	this.totalZB += z;
            	this.countB++;
            }
            
            public int averageXB() {
            	return countB == 0 ? 0 : totalXB/countB;
            }
            
            public int averageZB() {
            	return countB == 0 ? 0 : totalZB/countB;
            }
            
            public int averageXB(int x) {
            	return (totalXB + x) / (countB + 1);
            }
            
            public int averageZB(int z) {
            	return (totalZB + z) / (countB + 1);
            }
            
            private int totalXP = 0;
            private int totalZP = 0;
            private int countP = 0;
            
            public void addPosP(int x, int z) {
            	this.totalXP += x;
            	this.totalZP += z;
            	this.countP++;
            }
            ...
            public int averageXP() {
            	return countP == 0 ? 0 : totalXP/countP;
            }
            
            public int averageZP() {
            	return countP == 0 ? 0 : totalZP/countP;
            }
            
            public int averageXP(int x) {
            	return (totalXP + x) / (countP + 1);
            }
            
            public int averageZP(int z) {
            	return (totalZP + z) / (countP + 1);
            }
    ...
    public static class Torch extends StructureAbandonedVillagePieces.Village
        {
            ...
            public Torch(StructureAbandonedVillagePieces.Start start, int p_i45568_2_, Random rand, StructureBoundingBox p_i45568_4_, EnumFacing facing)
            {
            ...
            public static StructureBoundingBox findPieceBox(StructureAbandonedVillagePieces.Start start, List<StructureComponent> p_175856_1_, Random rand, int p_175856_3_, int p_175856_4_, int p_175856_5_, EnumFacing facing)
            {
    ...
    public abstract static class Village extends StructureComponent
        {
            ...
            protected Village(StructureAbandonedVillagePieces.Start start, int type)
            {
                super(type);
             ...
             */
            @Nullable
            protected StructureComponent getNextComponentNN(StructureAbandonedVillagePieces.Start start, List<StructureComponent> structureComponents, Random rand, int p_74891_4_, int p_74891_5_)
            {
                EnumFacing enumfacing = this.getCoordBaseMode();
                ...
                if (enumfacing != null)
                {
                    switch (enumfacing)
                    {
                        case NORTH:
                        default:
                            return StructureAbandonedVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, EnumFacing.WEST, this.getComponentType());
                        case SOUTH:
                            return StructureAbandonedVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, EnumFacing.WEST, this.getComponentType());
                        case WEST:
                            return StructureAbandonedVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                        case EAST:
                            return StructureAbandonedVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                    }
                }
             ...
             */
            @Nullable
            protected StructureComponent getNextComponentPP(StructureAbandonedVillagePieces.Start start, List<StructureComponent> structureComponents, Random rand, int p_74894_4_, int p_74894_5_)
            {
                EnumFacing enumfacing = this.getCoordBaseMode();
                ...
                if (enumfacing != null)
                {
                    switch (enumfacing)
                    {
                        case NORTH:
                        default:
                            return StructureAbandonedVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, EnumFacing.EAST, this.getComponentType());
                        case SOUTH:
                            return StructureAbandonedVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, EnumFacing.EAST, this.getComponentType());
                        case WEST:
                            return StructureAbandonedVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                        case EAST:
                            return StructureAbandonedVillagePieces.generateAndAddComponent(start, structureComponents, rand, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                    }
                }
            ...
            protected void replaceAirAndLiquidDownwards(Random rand, World worldIn, BlockSelector selector, int x, int y, int z, StructureBoundingBox boundingboxIn)
            {
                ...
                if (boundingboxIn.isVecInside(new BlockPos(i, j, k)))
                {
                    while ((worldIn.isAirBlock(new BlockPos(i, j, k)) || worldIn.getBlockState(new BlockPos(i, j, k)).getMaterial().isLiquid()) && j > 1)
                    {
                        ...
                        worldIn.setBlockState(new BlockPos(i, j, k), selector.getBlockState(), 2);
                        --j;
                    }
                }
            }
    ...
    public static class Well extends StructureAbandonedVillagePieces.Village
        {
            ...
            public Well(StructureAbandonedVillagePieces.Start start, int type, Random rand, int x, int z)
            {
                super(start, type);
            ...
            public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand)
            {
                StructureAbandonedVillagePieces.generateAndAddRoadPiece((StructureAbandonedVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX - 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.WEST, this.getComponentType());
                StructureAbandonedVillagePieces.generateAndAddRoadPiece((StructureAbandonedVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.EAST, this.getComponentType());
                StructureAbandonedVillagePieces.generateAndAddRoadPiece((StructureAbandonedVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                StructureAbandonedVillagePieces.generateAndAddRoadPiece((StructureAbandonedVillagePieces.Start)componentIn, listIn, rand, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
            }
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                IBlockState iblockstate = this.getBiomeSpecificBlockState(Blocks.MOSSY_COBBLESTONE.getDefaultState());
                //IBlockState iblockstate1 = this.getBiomeSpecificBlockState(Blocks.OAK_FENCE.getDefaultState());
                this.fillWithBlocks(worldIn, structureBoundingBoxIn, 1, 0, 1, 4, 12, 4, iblockstate, Blocks.ICE.getDefaultState(), false);
...
//                this.setBlockState(worldIn, iblockstate1, 4, 14, 4, structureBoundingBoxIn);
                ...
                for (int i = 0; i <= 5; ++i)
                {
                    for (int j = 0; j <= 5; ++j)
                    {
                        if (j == 0 || j == 5 || i == 0 || i == 5)
                        {
                            this.setBlockState(randomIn, worldIn, COBBLEMOSS5050, j, 11, i, structureBoundingBoxIn);
    ...
    public static class WoodHut extends StructureAbandonedVillagePieces.Village
        {
            ...
            public WoodHut(StructureAbandonedVillagePieces.Start start, int type, Random rand, StructureBoundingBox structurebb, EnumFacing facing)
            {
                super(start, type);
                this.setCoordBaseMode(facing);
            ...
            public static StructureAbandonedVillagePieces.WoodHut createPiece(StructureAbandonedVillagePieces.Start start, List<StructureComponent> p_175853_1_, Random rand, int p_175853_3_, int p_175853_4_, int p_175853_5_, EnumFacing facing, int p_175853_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175853_1_, structureboundingbox) == null ? new StructureAbandonedVillagePieces.WoodHut(start, p_175853_7_, rand, structureboundingbox, facing) : null;
            }
            ...
            public boolean addComponentParts(World worldIn, Random randomIn, StructureBoundingBox structureBoundingBoxIn)
            {
                ...
                this.fillWithRandomizedBlocks(worldIn, structureBoundingBoxIn, 0, 0, 0, 3, 0, 4, false, randomIn, COBBLEMOSS5050);
...
//                }
                ...
                for (int i = 0; i < 5; ++i)
                {
                    for (int j = 0; j < 4; ++j)
                    {
                        ...
                        this.replaceAirAndLiquidDownwards(randomIn, worldIn, COBBLEMOSS5050, j, -1, i, structureBoundingBoxIn);
                    }
                }
